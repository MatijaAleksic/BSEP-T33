package bsep.mojakuca.config;


import bsep.mojakuca.auth.RestAuthenticationEntryPoint;
import bsep.mojakuca.auth.TokenAuthenticationFilter;
import bsep.mojakuca.service.CustomUserDetailsService;
...
//	public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.POST, "/device_messsage");
