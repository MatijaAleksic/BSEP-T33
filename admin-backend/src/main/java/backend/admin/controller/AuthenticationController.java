...
import backend.admin.DTO.JwtAuthenticationRequest;
import backend.admin.model.User;
import backend.admin.DTO.UserTokenState;
import backend.admin.util.TokenUtils;
...
public class AuthenticationController {
    ...
    public ResponseEntity<UserTokenState> createAuthenticationToken(
        ...
        LOG.info("Received request from IP adress {}: {} {} ", request.getRemoteAddr(), request.getMethod(), request.getRequestURI());
